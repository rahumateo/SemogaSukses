...
public class NoAccessPermissionException_Exception_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public NoAccessPermissionException_Exception_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        dictionary.NoAccessPermissionException_Exception instance = null;
        java.lang.Object descriptionTemp = null;
        dictionary.NoAccessPermissionException_Exception_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_description_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new dictionary.NoAccessPermissionException_Exception_SOAPBuilder();
                    }
        ...
        if (isComplete) {
            instance = new dictionary.NoAccessPermissionException_Exception((java.lang.String)descriptionTemp);
        } else {
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        dictionary.NoAccessPermissionException_Exception instance = (dictionary.NoAccessPermissionException_Exception)obj;
