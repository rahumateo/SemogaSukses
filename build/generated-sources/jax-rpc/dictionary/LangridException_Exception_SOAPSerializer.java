...
public class LangridException_Exception_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public LangridException_Exception_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        dictionary.LangridException_Exception instance = null;
        java.lang.Object descriptionTemp = null;
        dictionary.LangridException_Exception_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_description_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new dictionary.LangridException_Exception_SOAPBuilder();
                    }
        ...
        if (isComplete) {
            instance = new dictionary.LangridException_Exception((java.lang.String)descriptionTemp);
        } else {
