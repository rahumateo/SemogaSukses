...
public class InvalidParameterException_Type_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public InvalidParameterException_Type_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        dictionary.InvalidParameterException_Type instance = null;
        java.lang.Object descriptionTemp = null;
        java.lang.Object parameterNameTemp = null;
        dictionary.InvalidParameterException_Type_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_description_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new dictionary.InvalidParameterException_Type_SOAPBuilder();
                    }
        ...
        if (isComplete) {
            instance = new dictionary.InvalidParameterException_Type((java.lang.String)descriptionTemp, (java.lang.String)parameterNameTemp);
        } else {
