...
public class EnId_bilingualdictionary_getSupportedMatchingMethods_Fault_SOAPSerializer extends SOAPFaultInfoSerializer {
    ...
    private static final int DICTIONARY_SERVICENOTACTIVEEXCEPTION_EXCEPTION_INDEX = 0;
    private static final int DICTIONARY_ACCESSLIMITEXCEEDEDEXCEPTION_EXCEPTION_INDEX = 1;
    private static final int DICTIONARY_SERVICENOTFOUNDEXCEPTION_EXCEPTION_INDEX = 2;
    private static final int DICTIONARY_PROCESSFAILEDEXCEPTION_EXCEPTION_INDEX = 3;
    private static final int DICTIONARY_SERVERBUSYEXCEPTION_EXCEPTION_INDEX = 4;
    private static final int DICTIONARY_NOVALIDENDPOINTSEXCEPTION_EXCEPTION_INDEX = 5;
    private static final int DICTIONARY_NOACCESSPERMISSIONEXCEPTION_EXCEPTION_INDEX = 6;
    
    public EnId_bilingualdictionary_getSupportedMatchingMethods_Fault_SOAPSerializer(boolean encodeType, boolean isNullable) {
        ...
        if (elementName.equals(ns1_fault_QNAME)) {
            if (elementType.equals(ns2_myAccessLimitExceededException_Exception_SOAPSerializer.getXmlType()) ||
                ...
                if (obj instanceof SOAPDeserializationState) {
                    builder = new dictionary.EnId_bilingualdictionary_getSupportedMatchingMethods_Fault_SOAPBuilder();
