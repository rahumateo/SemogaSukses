...
public class ProcessFailedException_Type_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public ProcessFailedException_Type_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        dictionary.ProcessFailedException_Type instance = null;
        java.lang.Object descriptionTemp = null;
        dictionary.ProcessFailedException_Type_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_description_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new dictionary.ProcessFailedException_Type_SOAPBuilder();
                    }
        ...
        if (isComplete) {
            instance = new dictionary.ProcessFailedException_Type((java.lang.String)descriptionTemp);
        } else {
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        dictionary.ProcessFailedException_Type instance = (dictionary.ProcessFailedException_Type)obj;
