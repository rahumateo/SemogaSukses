...
import info.ephyra.querygeneration.generators.BagOfTranslations;
...
public class IndoOpenEphyra2 {
    ...
    static String fileWrite = "res/test/clefid2A.txt";
    static String fileCevap = "res/test/clefIndoProp2.csv";
    ...
    public static void main(String[] args) {
        ...
        Logger.setLogfile("log/IndoOpenEphyra2");
        ...
        try {
            ...
            (new IndoOpenEphyra2()).commandLine();
     ...
     */
    protected IndoOpenEphyra2() throws IOException {
        this("");
     ...
     */
    public IndoOpenEphyra2(String dir) {
    ...
    protected void initFactoid() {
        ...
        QueryGeneration.addQueryGenerator(new BagOfTranslations());
    ...
    public void commandLine() throws IOException {
        ...
        while (true) {
            ...
            question = QuestionAnalyzer.analyze2(question);
    ...
    private static void printLog(String message) throws IOException {
        ...
        if (message.contains("Finish")) {
            ...
            System.out.println("*** Time spent : " + dur + " milliseconds ***");
...
//    private static void printQuestionProp() throws IOException {
//        cevap = new BufferedWriter(new FileWriter(fileCevap, true));
//
//        String q = PreAnalyzedQuestion.getQ_indo();
//        String qw = PreAnalyzedQuestion.getqWord();
//        String qen = PreAnalyzedQuestion.getQ_en();
//        String[] kw = PreAnalyzedQuestion.getKeywords();
//        String[] at = PreAnalyzedQuestion.getaType();
//        // , q , qw , qen, kw, at, time
//        cevap.write("," + q + "," + qw + "," + qen + ",");
//        for (String akw : kw) {
//            cevap.write(" -" + akw);
//        }
//        cevap.write(",");
...
//            cevap.write("´ -" + aat);
//        }
//        cevap.write("," + (System.currentTimeMillis() - begin) / 1000);
//        System.out.println("time spent : " + (System.currentTimeMillis() - begin) / 1000 + " seconds");
//        cevap.newLine();
//
//        cevap.close();
//    }
