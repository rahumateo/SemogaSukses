 ...
 * local text corpus. In contrast to <code>IndriKM</code>, whole documents are
 * returned instead of paragraphs.</p>
 *
 * <p>
...
public class IndriDocumentKM extends KnowledgeMiner {
     ...
     * queries and thus should be removed from query strings.</p>
     *
     * <p>
...
//            System.out.println("run query : " + query.getQueryString());
