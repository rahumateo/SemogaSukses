...
//    static BufferedWriter cevap;
    ...
    static String fileRead = "res/test/clefdefQ - Copy.txt";
//    static String fileWrite = "res/test/clefGoogleA.txt";
//    static String fileCevap = "res/test/clefGoogleCevap.csv";
...
//            printLog("*** System starts ***");
     ...
     */
    protected OpenEphyra() throws IOException {
        this("");
    }
...
//            long dur = (System.currentTimeMillis() - time) / 1000;
//            String res = results[i].getAnswer();
//            res = res.replaceAll(",", ".");
//            cevap.write("," + question + "," + res + ",");
//            for (String x : results[i].getNeTypes()) {
//                cevap.write("´-" + x + " ");
//            }
//            cevap.write("," + dur + "\n");
