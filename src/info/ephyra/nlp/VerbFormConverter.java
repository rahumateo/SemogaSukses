...
public class VerbFormConverter {
    ...
    public static String infinitiveToThirdPersonS(String verb) {
        ...
        if (verb.equals("have")) // "have" is irregular.
        {
            return "has";
        } else if (verb.matches(".*(ch|sh|s|x|z|o)")) // If the verb ends in "ch", "sh", "s", "x", "z" or "o",
        // append "es".
        {
            return verb + "es";
        } else if (verb.matches(".*[bcdfghjklmnpqrstvwxyz]y")) // If the verb ends in "y" immediately preceded by a consonant, drop
        // the "y" and append "ies".
        {
            return verb.substring(0, verb.length() - 1) + "ies";
        } else // If none of the above cases applies, just append "s".
        {
            return verb + "s";
        }
    }
