...
//            System.out.println("term1 : " + term.getText());
        }
...
//        for(Term term : terms){
//            System.out.println("term expanded : " + term);
//        }
    ...
    public static AnalyzedQuestion analyze(PreAnalyzedQuestion paq) {
        String question = PreAnalyzedQuestion.getQ_en();
        ...
        // extract keywords
        String[] kws = PreAnalyzedQuestion.getKeywords();
//        for (String x:kws) System.out.println("kw : " + x);
//        System.out.println("");
...
//        System.out.println("focus : " + focus);
	...
	// determine answer types
        String[] ats = PreAnalyzedQuestion.getaType();
        MsgPrinter.printAnswerTypes(ats);
        Logger.logAnswerTypes(ats);
...
//        }
        ...
        AnalyzedQuestion aq = new AnalyzedQuestion(question, qn, stemmed, verbMod, kws, nes, terms, ats, ps);
        aq.setTranslation(PreAnalyzedQuestion.getTransl());
        return aq;
    }
