...
//  private static final Logger log = Logger.getLogger(AnswerType.class);
     ...
     * <p>
     * This string cannot have multiple types at any level (e.g NUMEX|PERSON not
     * allowed) Any number of "."-separated subtypes can be present. Subtypes
     * called DEFAULT are ignored.
     *
