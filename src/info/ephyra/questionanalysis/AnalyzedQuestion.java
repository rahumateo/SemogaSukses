...
/**
 * <p>
 * An <code>AnalyzedQuestion</code> is a data structure representing a syntactic
 * and semantic analysis of a question.</p>
 *
 * <p>
 * This class implements the interface <code>Serializable</code>.</p>
 *
...
public class AnalyzedQuestion implements Serializable {
    ...
    /**
     * Ini bikin untuk keperluan AnalyzedQuestion untuk Indonesian Analyzer
     *
     * @param question
     * @param kws keywords
     * @param ats answer types
     */
    public AnalyzedQuestion(String question, String[] kws, String[] ats) {
        this(question);
        setKeywords(kws);
        setAnswerTypes(ats);
    }
     ...
     * @param qn Normalized Question
     * @param stemmed Stemmed verb and nouns Question
     * @param verbMod StemmedVerb Question
     * @param kws keywords
     * @param nes NE
     * @param terms Terms
     * @param ats answer types
    ...
    public AnalyzedQuestion(String question, String qn, String stemmed,
            String verbMod, String[] kws, String[][] nes, Term[] terms, String[] ats, Predicate[] ps) {
        this(question);
    ...
    public void setTranslation(Translations[] tr) {
        this.transl = tr;
    }
}
